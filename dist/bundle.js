...
/***/ "./src/directives/tg-direction.ts":
/*!****************************************!*\
  !*** ./src/directives/tg-direction.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"get\": () => (/* binding */ get)\n/* harmony export */ });\n// Default value\nvar DEFAULT = 'vertical';\nfunction get(value) {\n  return value ? value : DEFAULT;\n}\n\n//# sourceURL=webpack://Trigger/./src/directives/tg-direction.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getPercentage\": () => (/* binding */ getPercentage),\n/* harmony export */   \"getMappingValue\": () => (/* binding */ getMappingValue)\n/* harmony export */ });\n/* harmony import */ var _ease__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ease */ \"./src/ease.ts\");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ \"./src/helpers.ts\");\n\n\n\n/**\n * get the final percent with the percent function composed\n * @param ele \n * @returns \n */\nfunction getPercentage(ele) {\n  var percentFunc = ele.bezier ? (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.compose)(getInitPercentage, function (percentage) {\n    return (0,_ease__WEBPACK_IMPORTED_MODULE_0__.easePercentage)(ele.bezier, percentage);\n  }) : getInitPercentage;\n  return percentFunc(ele);\n}\n/**\n * get the mappingValue with the element\n * @param ele \n * @param percentage \n * @returns \n */\n\nfunction getMappingValue(ele, percentage) {\n  var from = ele.from,\n      segments = ele.segments,\n      decimals = ele.decimals,\n      increment = ele.increment,\n      multiplier = ele.multiplier;\n  var mappingValue = +(from + Math.floor((segments + 1) * percentage) * increment * multiplier).toFixed(decimals);\n  return mappingValue;\n}\n/**\n * get the initial percent with direction, size, position.\n * @param ele \n * @returns {number} percentage\n */\n\nfunction getInitPercentage(ele) {\n  var edge = ele.edge,\n      size = ele.size,\n      direction = ele.direction,\n      position = ele.position;\n\n  var _getViewInfo = getViewInfo(direction),\n      scrolled = _getViewInfo.scrolled,\n      viewSize = _getViewInfo.viewSize; // edge is 'cover' by default\n\n\n  var percentage = edge === 'cover' ? (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getValueInRange)((scrolled + viewSize - position) / (viewSize + size), 0, 1) : (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getValueInRange)((scrolled - position) / (size - viewSize), 0, 1);\n  return percentage;\n}\n/**\n * get the size and the position of the viewbox according to the direction.\n */\n\n\nfunction getViewInfo(direction) {\n  if (direction === 'vertical') {\n    return {\n      scrolled: document.documentElement.scrollTop,\n      viewSize: document.documentElement.clientHeight\n    };\n  } else {\n    return {\n      scrolled: document.documentElement.scrollLeft,\n      viewSize: document.documentElement.clientLeft\n    };\n  }\n}\n\n//# sourceURL=webpack://Trigger/./src/value.ts?");
