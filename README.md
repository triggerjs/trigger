...
| `tg-map`    | Optional | (Empty) | Map the value to another value. Format:<br>- 1-to-1: `value: newValue; value2: newValue2`.<br>- Multiple-to-1: `value,value2,value3: newValue`<br>- Range-to-1: `value...value2: newValue`                                                                                                                                                                                                                             |
